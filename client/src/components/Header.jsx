...
function Header() {
  ...
  return (
    ...
    <div>
      ...
      <img  className="header__logo-img" src={rmklogo} alt="" />
      ...
      <h1 className='bg-white inline absolute right-[60px] px-5 py-1 rounded-xl top-[140px]'>CampusConnect Powered by RMK Students</h1>
    </div>
  )
}
